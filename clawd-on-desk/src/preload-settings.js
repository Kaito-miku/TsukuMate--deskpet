...
contextBridge.exposeInMainWorld("settingsAPI", {
  ...
  getLive2dSettings: () => ipcRenderer.invoke("settings:live2d-get"),
  setLive2dSettings: (payload) => ipcRenderer.invoke("settings:live2d-set", payload || {}),
...
contextBridge.exposeInMainWorld("minicpmSettings", {
  ...
  savePersonaProfiles: (payload) => ipcRenderer.invoke("minicpm-settings:save-persona-profiles", payload || {}),
  getAppleMusicConfig: () => ipcRenderer.invoke("minicpm-settings:get-apple-music-config"),
  setAppleMusicConfig: (config) => ipcRenderer.invoke("minicpm-settings:set-apple-music-config", config || {}),
  clearApiKey: () => ipcRenderer.invoke("minicpm-settings:clear-api-key"),
  testApi: () => ipcRenderer.invoke("minicpm-settings:test-api"),
  ...
  openChatHistoryDir: () => ipcRenderer.invoke("minicpm-settings:open-chat-history-dir"),
