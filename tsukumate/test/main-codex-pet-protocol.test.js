...
test("package metadata registers TsukuMate and legacy import protocols", () => {
  ...
  assert.ok(protocols.some((entry) => Array.isArray(entry.schemes) && entry.schemes.includes("tsukumate")));
