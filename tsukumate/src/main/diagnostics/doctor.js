...
const { checkLocalServer } = require("./detectors/local-server");
const { checkAgentIntegrations } = require("./detectors/agent-integrations");
const { checkPermissionBubblePolicy } = require("./detectors/permission-bubble-policy");
const { checkThemeHealth } = require("./detectors/theme-health");
