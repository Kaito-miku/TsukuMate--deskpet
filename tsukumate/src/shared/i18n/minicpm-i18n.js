...
(function initMinicpmI18n(root) {
  ...
  const EN_STRINGS = {
    ...
    onboardingWindowTitle: "TsukuMate — First Launch",
    onboardingStepEnvCheck: "Environment",
    onboardingStepModel: "Model",
    onboardingStepReady: "Ready",
    // Step 1: env-check
    onboardingEnvWelcome: "Welcome to TsukuMate",
    ...
    chatScreenRead: "Read screen",
    chatScreenPickTitle: "Choose a display",
    chatScreenPickHint: "Its image is sent only with your next message.",
    chatScreenAttachment: "Screen attached for this message",
    chatScreenRemove: "Remove screen image",
    chatScreenCancel: "Cancel",
    chatScreenUnavailableLocal: "Screen understanding needs API mode with a vision model.",
    chatScreenPermissionRequired: "Allow Screen Recording for this app in System Settings, then try again.",
    chatScreenPermissionOpen: "Open System Settings",
    chatScreenCaptureFailed: "Couldn't capture the selected screen. Try again.",
    chatScreenSourceUnavailable: "That display is no longer available. Choose it again.",
    chatScreenCaptureExpired: "That screen image is no longer available. Capture it again.",
    chatHotkeyHint: "⌘Enter to send, ⌘⇧M to toggle, ⌘⇧T for thinking",
  ...
  const ZH_STRINGS = {
    ...
    chatScreenRead: "读取屏幕",
    chatScreenPickTitle: "选择要读取的屏幕",
    chatScreenPickHint: "图片只会随下一条消息发送一次。",
    chatScreenAttachment: "已附加屏幕图片，仅用于本条消息",
    chatScreenRemove: "移除屏幕图片",
    chatScreenCancel: "取消",
    chatScreenUnavailableLocal: "屏幕理解需要使用支持视觉的 API 模型。",
    chatScreenPermissionRequired: "请在系统设置中允许此应用进行屏幕录制，然后再试一次。",
    chatScreenPermissionOpen: "打开系统设置",
    chatScreenCaptureFailed: "无法截取所选屏幕，请重试。",
    chatScreenSourceUnavailable: "所选屏幕已不可用，请重新选择。",
    chatScreenCaptureExpired: "这张屏幕图片已失效，请重新截取。",
    chatHotkeyHint: "⌘Enter 发送，⌘⇧M 开关，⌘⇧T 思考模式",
  ...
  const ZH_TW_STRINGS = {
    ...
    chatScreenRead: "讀取螢幕",
    chatScreenPickTitle: "選擇要讀取的螢幕",
    chatScreenPickHint: "圖片只會隨下一則訊息傳送一次。",
    chatScreenAttachment: "已附加螢幕圖片，僅用於本則訊息",
    chatScreenRemove: "移除螢幕圖片",
    chatScreenCancel: "取消",
    chatScreenUnavailableLocal: "螢幕理解需要使用支援視覺的 API 模型。",
    chatScreenPermissionRequired: "請在系統設定中允許此應用程式進行螢幕錄製，然後再試一次。",
    chatScreenPermissionOpen: "開啟系統設定",
    chatScreenCaptureFailed: "無法截取所選螢幕，請重試。",
    chatScreenSourceUnavailable: "所選螢幕已不可用，請重新選擇。",
    chatScreenCaptureExpired: "這張螢幕圖片已失效，請重新截取。",
    chatHotkeyHint: "⌘Enter 傳送，⌘⇧M 開關，⌘⇧T 思考模式",
  ...
  const KO_STRINGS = {
    ...
    chatScreenRead: "화면 읽기",
    chatScreenPickTitle: "화면 선택",
    chatScreenPickHint: "이미지는 다음 메시지 한 번에만 전송됩니다.",
    chatScreenAttachment: "이 메시지에 화면 첨부됨",
    chatScreenRemove: "화면 이미지 제거",
    chatScreenCancel: "취소",
    chatScreenUnavailableLocal: "화면 이해에는 비전 모델을 사용하는 API 모드가 필요합니다.",
    chatScreenPermissionRequired: "시스템 설정에서 이 앱의 화면 기록을 허용한 뒤 다시 시도하세요.",
    chatScreenPermissionOpen: "시스템 설정 열기",
    chatScreenCaptureFailed: "선택한 화면을 캡처할 수 없습니다. 다시 시도하세요.",
    chatScreenSourceUnavailable: "선택한 화면을 더 이상 사용할 수 없습니다. 다시 선택하세요.",
    chatScreenCaptureExpired: "이 화면 이미지는 더 이상 사용할 수 없습니다. 다시 캡처하세요.",
    chatHotkeyHint: "⌘Enter 전송, ⌘⇧M 토글, ⌘⇧T 생각 모드",
  ...
  const JA_STRINGS = {
    ...
    chatScreenRead: "画面を読む",
    chatScreenPickTitle: "画面を選択",
    chatScreenPickHint: "画像は次のメッセージ一回だけ送信されます。",
    chatScreenAttachment: "このメッセージに画面を添付済み",
    chatScreenRemove: "画面画像を削除",
    chatScreenCancel: "キャンセル",
    chatScreenUnavailableLocal: "画面の理解には、画像対応モデルを使う API モードが必要です。",
    chatScreenPermissionRequired: "システム設定でこのアプリの画面収録を許可してから、もう一度試してください。",
    chatScreenPermissionOpen: "システム設定を開く",
    chatScreenCaptureFailed: "選択した画面を取得できませんでした。もう一度試してください。",
    chatScreenSourceUnavailable: "選択した画面は利用できなくなりました。もう一度選んでください。",
    chatScreenCaptureExpired: "この画面画像は利用できなくなりました。もう一度取得してください。",
    chatHotkeyHint: "⌘Enter で送信、⌘⇧M で開閉、⌘⇧T で思考モード",
