...
contextBridge.exposeInMainWorld("chatWorkspace", {
  ...
  updateMessage: (id, content, conversationId) => ipcRenderer.invoke("chat-workspace:update-message", { id, content, conversationId }),
  regenerateMessage: (id) => ipcRenderer.invoke("chat-workspace:regenerate-message", { id }),
  deleteMessage: (id, conversationId) => ipcRenderer.invoke("chat-workspace:delete-message", { id, conversationId }),
  createConversation: () => ipcRenderer.invoke("chat-workspace:create-conversation"),
  createBranch: (payload) => ipcRenderer.invoke("chat-workspace:create-branch", payload || {}),
  listConversations: () => ipcRenderer.invoke("chat-workspace:list-conversations"),
  getConversationNetwork: () => ipcRenderer.invoke("chat-workspace:get-conversation-network"),
  saveConversationNetworkLayout: (positions) => ipcRenderer.invoke("chat-workspace:save-conversation-network-layout", { positions: positions || {} }),
  ...
  listSpecialDiaries: () => ipcRenderer.invoke("chat-workspace:list-special-diaries"),
  loadSpecialDiary: (id) => ipcRenderer.invoke("chat-workspace:load-special-diary", { id }),
  saveSpecialDiary: (id, content) => ipcRenderer.invoke("chat-workspace:save-special-diary", { id, content }),
  deleteSpecialDiary: (id) => ipcRenderer.invoke("chat-workspace:delete-special-diary", { id }),
  openSpecialDiaryFolder: () => ipcRenderer.invoke("chat-workspace:open-special-diary-folder"),
