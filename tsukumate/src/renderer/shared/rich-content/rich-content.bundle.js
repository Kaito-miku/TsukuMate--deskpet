(() => {
  ...
  var require_index = __commonJS({
    "src/renderer/shared/rich-content/index.js"() {
      init_purify_es();
      var BLOCKED_TAGS = ["script", "form", "iframe", "object", "embed", "meta", "link", "base", "video", "audio"];
