...
(function initSettingsUiCore(root) {
  ...
  const COLLAPSED_GROUPS_STORAGE_KEY = "tsukumate.settings.collapsedGroups.v1";
  const LEGACY_COLLAPSED_GROUPS_STORAGE_KEY = "clawd.settings.collapsedGroups.v1";
  ...
  function readCollapsedGroupState() {
    try {
      const raw = localStorage.getItem(COLLAPSED_GROUPS_STORAGE_KEY)
        || localStorage.getItem(LEGACY_COLLAPSED_GROUPS_STORAGE_KEY);
